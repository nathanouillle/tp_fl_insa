...
dataset = 'CIFAR-10' # 'CIFAR-10' or 'MNIST'
...
# federated learning
federated_learning = federated(X_clients, y_clients, X_test, y_test, fl_iterations=epochs, n_adversaire=0,epochs_FL=epochs_FL,dataset=dataset)
